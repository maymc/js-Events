...
var baconBtn = document.getElementById("one");
baconBtn.addEventListener('click', moreContent);
...
var redBtn = document.getElementById("drink");
redBtn.addEventListener('click', redFace);
...
function secret(){
	...
	var temp = document.getElementById("showmoney");
...
showHideBtn.addEventListener('click', secret);
