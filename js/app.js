...
var menuItems = ["fries", "mcChicken", "mcFlurry"];
...
buttonElem.addEventListener("click", quoteGenerate);
...
var quoteNum = Math.floor(Math.random()*3);
console.log(quoteNum);

var btnElem = document.getElementById("random");
btnElem.addEventListener("click", randomQuote);

function randomQuote(){
	document.getElementById("displayQuotes").innerHTML = quotes[quoteNum];
}
...
var btnElem2 = document.getElementById("showHide");
btnElem2.addEventListener("click", showHideSecret);

function showHideSecret(){
	var hide = document.getElementById("showmoney");
